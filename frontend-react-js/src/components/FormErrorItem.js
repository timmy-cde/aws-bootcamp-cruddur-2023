export default function FormErrorItem(props) {
  const render_error = () => {
    switch (props.err_code) {
      ...
      case "message_exceed_max_chars":
        return "The message is too long. It should be lesss than 1024 characters";
      // Users
      case "message_group_uuid_blank":
        return "You message group cannot be blank";
      ...
      // In the case for error return from cognito,
      // they directly return the error so we just display it.
      default:
